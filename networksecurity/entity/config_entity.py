...
class ModelTrainerConfig:
    def __init__(self,training_pipeline_config:TrainingPipelineConfig):
        ...
        self.trained_model_file_path:str= os.path.join(
            self.model_trainer_dir,training_pipline.model_trainer_trained_model_dir,training_pipline.model_file_name
        )
        self.expected_accurecy:float=training_pipline.model_trainer_expected_score
        self.overfitting_underfitting_threshold = training_pipline.model_trainer_over_fitting_under_fitting_threshold
